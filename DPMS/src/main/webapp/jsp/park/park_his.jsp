  ...
  <body>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
	    	...
	    	<div class="templatemo-content-container">
			          ...
			          <div class="row">
			            <nav class="templatemo-top-nav col-lg-12 col-md-12">
			              <ul class="text-uppercase">
			                <li><a href="findAllPark">停车记录</a></li>
			                <li><a href="findHisAllPark" class="active">历史记录</a></li>
			              </ul>  
			            </nav> 
			          </div>
			        </div>
	                ...
	                <tbody>
						<c:forEach items="${dpmsParks}" var="dpmsPark">
							<tr>
								...
								<td style="text-align: center;">${dpmsPark.price}元</td>
	          ...
	          <jsp:include page="park_his_footer.jsp"></jsp:include>
	      </div>       
	    </div >         
  	</div> 
