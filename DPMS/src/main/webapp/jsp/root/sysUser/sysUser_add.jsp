            		...
            		<p>>>添加</p>
			           ...
			           <form action="#" class="templatemo-login-form" method="post" enctype="multipart/form-data">
			              <div class="row form-group">	               
				                <div class="col-lg-6 col-md-6 form-group has-error">                  
				                    <label for="userName">用户名</label>
				                    <input type="text" class="form-control" id="userName" name="userName" min="4" maxlength="10" required="required">                  
				                </div> 
				                <div class="col-lg-6 col-md-6 form-group has-error">                  
				         ...
				         <div class="row form-group">
				                <div class="col-lg-6 col-md-6 form-group has-error">                  
				                    ...
				                    <input type="text" class="form-control" id="cardId" name="cardId" required="required">                  
				                </div> 
				                <div class="col-lg-6 col-md-6 form-group">                  
