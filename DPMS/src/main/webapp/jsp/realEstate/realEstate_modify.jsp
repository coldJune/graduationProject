			              ...
			              <div class="row form-group">
			               ...
			               <div class="row form-group">
				                <div class="col-lg-6 col-md-6 form-group">  
					                 ...
					                 <select name="${dpmsRealEstate.hasDoor }" class="form-control">
				               ...
				               <div class="col-lg-6 col-md-6 form-group">  
					                 ...
					                 <select name="${dpmsRealEstate.hasGas }" class="form-control">
			               ...
			               <div class="row form-group">
			                	<div class="col-lg-6 col-md-6 form-group">  
					                 ...
					                 <select name="${dpmsRealEstate.hasBordhand }" class="form-control">
