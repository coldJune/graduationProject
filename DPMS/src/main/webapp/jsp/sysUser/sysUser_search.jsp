    		...
    		$('#del').click(function(){
    			...
    			if(userNames==null){
        			...
        			$.ajax({
        				...
        				success:function(){
        					alert("删除成功");
        					window.location.href='findAllSysUser';
        				},
        				failure:function(){
        					alert('删除失败');
        				}
  ...
  <body>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
	    	...
	    	<div class="templatemo-content-container">
	          ...
	          <h2 class="margin-bottom-10"><strong>用户信息</strong></h2>
            			<p><i>>>查询结果</i></p>
	          		<div style="margin: 0 auto;">
			        	...
			        	<div class="form-group text-right" style="width: 40%;float: right;">
				                <button id="delSysUser" type="button" class="templatemo-blue-button">删除</button>
				       	</div>
	          		</div>
