			           ...
			           <form  action="addSysUser" class="templatemo-login-form" method="post" enctype="multipart/form-data">
			              <div class="row form-group">	               
				                <div class="col-lg-6 col-md-6 form-group">                  
				                    ...
				                    <input type="text" class="form-control" id="userName" name="userName" value="${dpmsSysUser.userName}" required="required">                  
				                </div>
				                 <div class="col-lg-6 col-md-6 form-group">                  
			              ...
			              <div class="row form-group">
			              		<div class="col-lg-6 col-md-6 form-group">                  
				                    ...
				                    <input type="text" class="form-control" id="cardId" name="cardId" maxlength="18" min="15" required="required">                  
				                </div>  
				                <div class="col-lg-6 col-md-6 form-group">                  
