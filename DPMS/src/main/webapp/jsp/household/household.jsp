  ...
  <body>
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          ...
          <%} %>
            <li><a href="../realEstate/findAllRealEstate" class="active"><i class="fa fa-bar-chart fa-fw"></i>楼盘信息管理</a></li>
	                ...
	                <tbody>
						<c:forEach items="${dpmsHouseholds}" var="dpmsHousehold">
							<tr>
								...
								<td style="text-align: center;"><a href="showDetailHousehold?id=${dpmsHousehold.id}" style="color:blue;text-decoration: underline;" class="templatemo-sort-by"><i>${dpmsHousehold.id}</i></a></td>
